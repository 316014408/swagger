...
func (suite *ParserSuite) SetupSuite() {
	if initialisedParser2 == nil {
		...
		initialisedParser2.ParseGeneralApiInfo(path.Join(gopath, "src", "github.com/316014408/swagger/example/web/main.go"))
		initialisedParser2.ParseApi("github.com/316014408/swagger/example")
	}
